...
void get_stus(Stu stus[],int *student_count)
{
    ...
    *student_count=N;
    while (N1--)
    {
        ...
        printf(stus[i].names_id,"2025%03d:%s",i+1,name);
...
void calculate_student_averages( int averages[],Stu stus[],int student_count) {
...
/*#ifndef ONLINE_JUDGE
    ...
    calculate_student_averages(averages,stus, students_count);  //return bug
